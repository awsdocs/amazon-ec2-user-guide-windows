...
Some of these metrics have differences on Nitro\-based instances\. For a list of instance types based on the Nitro system, see [Nitro\-based Instances](instance-types.md#ec2-nitro-instances)\.
