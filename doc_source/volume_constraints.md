# Constraints on the Size of an EBS Volume<a name="volume_constraints"></a>
...
The following describe the most important factors that limit the usable size of an EBS volume and recommendations for your EBS volumes\.

**Topics**
+ [Service Limitations](#aws_limits)
+ [Partitioning Schemes](#partitioning)
+ [Data Block Sizes](#block_size)
+ [Recommendations for Volumes](#window-volumes)
...
## Recommendations for Volumes<a name="window-volumes"></a>
