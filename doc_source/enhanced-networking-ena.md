...
| --- | --- | --- | 
|  [2\.2\.2](https://s3.amazonaws.com/ec2-windows-drivers-downloads/ENA/2.2.2/AwsEnaNetworkDriver.zip)  | New FeatureAdds support to query network adapter performance metrics with CloudWatch and the Performance Counters for Windows consumers\. Bug Fix [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/enhanced-networking-ena.html) | December 21, 2020 | 
|  [2\.2\.1](https://s3.amazonaws.com/ec2-windows-drivers-downloads/ENA/2.2.1/AwsEnaNetworkDriver.zip)  | New FeatureAdds a method to allow the host to query the Elastic Network Adapter for network performance metrics\. | October 1, 2020 | 
...
|  [2\.1\.5](https://s3.amazonaws.com/ec2-windows-drivers-downloads/ENA/2.1.5/AwsEnaNetworkDriver.zip)  | Bug Fix Fixes occasional network adapter initialization failure on bare metal instances\. | June 23, 2020 | 
