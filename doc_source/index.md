...
+ [Amazon EC2 instances](Instances.md)
   ...
   + [Instance purchasing options](instance-purchasing-options.md)
      ...
      + [Spot Instances](using-spot-instances.md)
         ...
         + [Work with Spot Instances](spot-requests.md)
         ...
         + [Spot Instance quotas](using-spot-limits.md)
      ...
      + [On-Demand Capacity Reservations](ec2-capacity-reservations.md)
         ...
         + [Monitoring Capacity Reservations](cr-monitor.md)
            + [Monitor Capacity Reservations using CloudWatch metrics](capacity-reservation-cw-metrics.md)
            + [Monitor Capacity Reservations using EventBridge](cr-eventbridge.md)
   ...
   + [Connect](connect.md)
      ...
      + [Connect your EC2 instance to an AWS resource](connect-instance-to-resources.md)
         + [Tutorial: Connect an Amazon EC2 instance to an Amazon RDS database](tutorial-connect-ec2-instance-to-rds-database.md)
            ...
            + [Clean up](tutorial-ec2-rds-clean-up.md)
...
+ [Monitor Amazon EC2](monitoring_ec2.md)
   ...
   + [Automate Amazon EC2 using EventBridge](automating_with_eventbridge.md)
...
+ [Networking in Amazon EC2](ec2-networking.md)
   ...
   + [Enhanced networking on Windows](enhanced-networking.md)
      ...
      + [Improve network performance with ENA Express on Windows instances](ena-express.md)
   ...
   + [Placement groups](placement-groups.md)
      + [Share a placement group](share-placement-group.md)
...
+ [Resources and tags](EC2_Resources.md)
   + [Recycle Bin](recycle-bin.md)
      ...
      + [Monitor Recycle Bin](rbin-monitor.md)
         + [Monitor Recycle Bin using Amazon EventBridge](rbin-eventbridge.md)
         + [Monitor Recycle Bin using AWS CloudTrail](recycle-bin-ct.md)
