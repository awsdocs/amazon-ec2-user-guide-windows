...
You can change the tenancy of an instance from `dedicated` to `host`, or from `host` to `dedicated` after you've launched it\. For more information, see [Change the tenancy of an instance](#dedicated-change-tenancy)\.
...
1. If the **Tenancy** column is not displayed, choose the settings icon \( ![\[Image NOT FOUND\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/settings-icon.png) \) in the top\-right corner, toggle on **Tenancy**, and choose **Confirm**\.
...
1. If the **Tenancy** column is not displayed, do one of the following: 
   + Choose the settings icon \( ![\[Image NOT FOUND\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/settings-icon.png) \) in the top\-right corner, toggle on **Tenancy**, and choose **Confirm**\.
