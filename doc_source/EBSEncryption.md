...
![\[Copy an encrypted snapshot and encrypt the copy to a new KMS key.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/volume-reencrypt.png)
...
![\[Copy an encrypted snapshot and encrypt the copy to a new KMS key.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/snap-reencrypt.png)
