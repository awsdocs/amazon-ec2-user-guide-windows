# Amazon EC2 Security Groups for Windows Instances<a name="using-network-security"></a>
...
If you need to allow traffic to a Linux instance, see [Amazon EC2 Security Groups for Linux Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html) in the *Amazon EC2 User Guide for Linux Instances*\.
