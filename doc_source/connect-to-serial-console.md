...
+ Supported for all virtualized instances built on the [Nitro System](instance-types.md#ec2-nitro-instances): C5, C5a, C5ad, C5d, C5n, C6i, D3, D3en, G4, G4ad, G5, I3en, M5, M5a, M5ad, M5d, M5dn, M5n, M5zn, M6a, M6i, `p3dn.24xlarge`, R5, R5a, R5ad, R5b, R5d, R5dn, R5n, R6i, T3, T3a, high memory \(u\-\*\), and z1d
