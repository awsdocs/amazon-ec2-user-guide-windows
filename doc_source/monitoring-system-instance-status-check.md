...
![\[Viewing status\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/status-check-tab.png)

1. If you have an instance with a failed status check and the instance has been unreachable for over 20 minutes, choose **AWS Support** to submit a request for assistance\. 
