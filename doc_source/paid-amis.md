...
### Finding a Paid AMI Using the Tools for Windows PowerShell<a name="finding-paid-windows-ami-twp"></a>

You can find a paid AMI using the following [Get\-EC2Image](http://docs.aws.amazon.com/powershell/latest/reference/items/Get-EC2Image.html) command\.
