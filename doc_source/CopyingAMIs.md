...
![\[Copy an encrypted source AMI\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/ami-to-ami-encrypted.png)
...
![\[Copy an unencrypted source AMI to encrypted target AMI\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/ami-to-ami-convert.png)
