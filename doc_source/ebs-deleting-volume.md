...
**Note**  
You can't delete a volume if it's attached to an instance\. To delete a volume, you must first detach it\. For more information, see [Detaching an Amazon EBS volume from a Windows instance](ebs-detaching-volume.md)\.  
