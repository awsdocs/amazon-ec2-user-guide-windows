...
![\[New credits earned are discarded once the limit is exceeded.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-t3-bucket.png)
...
![\[A t3.large instance with an average CPU utilization below baseline.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/baseline-utilization.png)