...
Windows Firewall may also block incoming traffic\. If you're having trouble setting up access to your instance, you may have to disable Windows Firewall\. For more information, see [Remote Desktop Can't onnect to the Remote Computer](troubleshoot-connect-windows-instance.md#rdp-issues)\.
