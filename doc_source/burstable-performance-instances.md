...
+ The supported purchasing options are: On\-Demand Instances, Reserved Instances, Dedicated Instances, and Spot Instances\. These instances are not supported as Scheduled Instances or on a Dedicated Host\. For more information, see [Instance purchasing options](instance-purchasing-options.md)\.
