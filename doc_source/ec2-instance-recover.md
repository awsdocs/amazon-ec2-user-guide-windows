...
+ Uses one of the following instance types: C3, C4, C5, C5a, C5n, M3, M4, M5, M5a, M5n, M5zn, M6i, P3, R3, R4, R5, R5a, R5b, R5n, T2, T3, T3a, high memory \(virtualized only\), X1, X1e
