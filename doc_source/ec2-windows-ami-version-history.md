...
| Release | Changes | 
| --- | --- | 
| 2021\.02\.10 |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-windows-ami-version-history.html) Beginning in March 2021, AWS\-provided Windows AMIs will include Amazon Root CAs in the certificate store to minimize potential disruption from the upcoming S3 and CloudFront certificate migration, which is scheduled for March 23rd, 2021\. For more information, see  [https://aws\.amazon\.com/blogs/security/how\-to\-prepare\-for\-aws\-move\-to\-its\-own\-certificate\-authority/](https://aws.amazon.com/blogs/security/how-to-prepare-for-aws-move-to-its-own-certificate-authority/) [https://forums\.aws\.amazon\.com/ann\.jspa?annID=7541](https://forums.aws.amazon.com/ann.jspa?annID=7541)  Additionally, AWS will apply "update for Removal of Adobe Flash Player" \(KB4577586\) to all Windows AMIs in March to remove the built\-in Adobe Flash player, which ended support on December 31st, 2020\. If your use case requires the built\-in Adobe Flash player, we recommend creating a custom image based on AMIs with version 2021\.02\.10 or earlier\. For more information on the End of Support of Adobe Flash Player, see:  [https://blogs\.windows\.com/msedgedev/2020/09/04/update\-adobe\-flash\-end\-support/](https://blogs.windows.com/msedgedev/2020/09/04/update-adobe-flash-end-support/) [https://www\.adobe\.com/products/flashplayer/end\-of\-life\.html](https://www.adobe.com/products/flashplayer/end-of-life.html)  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-windows-ami-version-history.html) [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-windows-ami-version-history.html)  | 
