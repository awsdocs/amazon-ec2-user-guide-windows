...
1. To enable hibernation, configure the following fields in the launch instance wizard:
   ...
   1. Under **Application and OS Images \(Amazon Machine Image\)**, select an AMI that supports hibernation\. For more information, see [Supported Windows AMIs](hibernating-prerequisites.md#hibernation-prereqs-supported-amis)\.
