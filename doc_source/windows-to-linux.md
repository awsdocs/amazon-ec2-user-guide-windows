# Windows to Linux Replatforming Assistant for Microsoft SQL Server Databases<a name="windows-to-linux"></a>
...
**Topics**
+ [Concepts](#windows-to-linux-concepts)
+ [Related Services](#windows-to-linux-related-services)
+ [How Windows to Linux Replatforming Assistant for Microsoft SQL Server Works](#windows-to-linux-how-it-works)
+ [Components](#windows-to-linux-components)
+ [Setting Up](windows-to-linux-setting-up.md)
+ [Getting Started](windows-to-linux-getting-started.md)

## Concepts<a name="windows-to-linux-concepts"></a>
...
## Related Services<a name="windows-to-linux-related-services"></a>
...
## How Windows to Linux Replatforming Assistant for Microsoft SQL Server Works<a name="windows-to-linux-how-it-works"></a>
...
## Components<a name="windows-to-linux-components"></a>
