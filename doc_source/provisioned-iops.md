...
| Use cases |  Workloads that require: [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/provisioned-iops.html)  |  [\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/provisioned-iops.html)  | 
...
\* `io2` Block Express volumes are supported with R5b, Trn1, X2idn, and X2iedn instances only\. `io2` volumes attached to these instances, during or after launch, automatically run on Block Express\. For more information, see [`io2` Block Express volumes](#io2-block-express)\.
...
**Note**  
`io2` Block Express volumes are supported with R5b, Trn1, X2idn, and X2iedn instances only\.
...
+ `io2` Block Express volumes are currently supported with R5b, Trn1, X2idn, and X2iedn instances only\.
