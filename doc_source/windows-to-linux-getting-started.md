# Getting Started<a name="windows-to-linux-getting-started"></a>
...
**Topics**
+ [Running the Windows to Linux Replatforming Assistant for Microsoft SQL Server Script](#windows-to-linux-script)
+ [Parameters](#windows-to-linux-parameters)

## Running the Windows to Linux Replatforming Assistant for Microsoft SQL Server Script<a name="windows-to-linux-script"></a>
...
## Parameters<a name="windows-to-linux-parameters"></a>
