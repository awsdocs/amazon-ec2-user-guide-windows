...
![\[T3 Standard instance CPU utilization.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t3_standard_graph.png)
...
![\[In period 1 for the T2 standard, the credit balance is 102 credits.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-graph1.png)
...
![\[The credit balance has reached its limit of 72 accrued earned credits.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-graph2.png)
...
![\[Newly earned credits are discarded because the credit balance is already at its limit.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-graph3.png)
...
![\[The balance plateaus at 72 credits, because there are no accrued launch credits.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-graph4.png)
...
![\[At the end of three hours, the credit balance is 45 accrued earned credits.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-graph5.png)
...
![\[The instance earns more credits than it spends.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-graph6.png)
...
![\[Earned credits that exceed the limit are discarded.\]](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/images/t2-graph7.png)
