# EC2 Serial Console for Windows instances<a name="ec2-serial-console"></a>
...
If you are using a Linux instance, see [EC2 Serial Console for Linux instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/serial-console.html) in the *Amazon EC2 User Guide for Linux Instances*\.
