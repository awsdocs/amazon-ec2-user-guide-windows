...
+ **Enhanced networking**: Instance types that support [enhanced networking](enhanced-networking.md) require the necessary drivers installed\. For example, the C5, C5d, M5, and M5d instance types require EBS\-backed AMIs with the Elastic Network Adapter \(ENA\) drivers installed\. If you are resizing an existing instance to an instance that supports enhanced networking, then you must first install the [ENA](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/enhanced-networking-ena.html) or [ixgbevf](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/sriov-networking.html) drivers on your instance, as appropriate\.
+ **NVMe**: Some instance types, such as C5, C5d, M5, and M5d, expose EBS volumes as NVMe block devices\. If you are resizing an instance to one of these instance types, you must first install the [NVMe](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/nvme-ebs-volumes.html) drivers on your instance\. For more information about supported AMIs, see the Release Notes in [Compute Optimized Instances](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/compute-optimized-instances.html) and [General Purpose Instances](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/general-purpose-instances.html)\.
