# Resizing Your Instance<a name="ec2-instance-resize"></a>
...
+  C5 instances require EBS\-backed AMIs with the NVMe and Elastic Network Adapter \(ENA\) drivers installed\. For information about AMIs supported on C5, see the Release Notes in [Compute Optimized Instances](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/compute-optimized-instances.html)\. If you are trying to resize an existing instance to a C5 instance, then you will first need to install the [NVMe](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/nvme-ebs-volumes.html) and [ENA](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/enhanced-networking-ena.html) drivers on your AMI\.
