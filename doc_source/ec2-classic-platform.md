...
If you have other resources in EC2\-Classic, you can take steps to migrate them to a VPC\. For more information, see [Migrating from a Windows Instance in EC2\-Classic to a Windows Instance in a VPC](vpc-migrate.md)\.
