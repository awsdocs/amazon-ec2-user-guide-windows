...
1. For **Launch template contents**, provide the following information:
   ...
   + **Key pair name**: Choose the key pair for the instance\. For more information, see [Amazon EC2 Key Pairs and Windows Instances](ec2-key-pairs.md)\.
   ...
   + **Security Groups**: Choose one or more security groups to associate with the instance\. For more information, see [Amazon EC2 Security Groups for Windows Instances](using-network-security.md)\.
