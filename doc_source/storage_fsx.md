...
For more information, see the [FSx for Windows File Server User Guide](https://docs.aws.amazon.com/fsx/latest/WindowsGuide/)\. For pricing information, see [FSx for Windows File Server Pricing](http://aws.amazon.com/fsx/windows/pricing/)\.